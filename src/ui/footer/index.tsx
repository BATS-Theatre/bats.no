...
export default async function Footer() {
	...
	return (
		<footer className="bg-ink text-canvas" role="contentinfo">
			...
			{copyright && (
				<div className="border-canvas/20 mx-auto flex max-w-7xl flex-wrap justify-center gap-x-6 gap-y-2 border-t p-4 pb-[max(1rem,env(safe-area-inset-bottom))] text-sm [&_a:hover]:underline">
